<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogIn.aspx.cs" Inherits="Disaster_Alleviation_Foundation.WebForm1" %>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
					...
					<asp:Button ID="btnLogin" runat="server" class="btn btn-primary rounded submit p-3 px-5" Text="Admin Log-in" OnClick="btnLogin_Click" />
	            </div>
	                    </form>
	        </div>
				</div>

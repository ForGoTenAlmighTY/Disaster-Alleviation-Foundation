<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsAdmin.aspx.cs" Inherits="Disaster_Alleviation_Foundation.GoodsAdmin" %>
...
<body>
    <header>
        ...
        <div class="auto-style2" style="height: 153px">
            <h2 class="auto-style3">New Goods</h2>
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form id="form2" runat="server">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtName" type="text" class="form-control rounded-left" placeholder="Item Name" runat="server" required></asp:TextBox>
                            </div>
                            <div class="form-group">

                                <asp:TextBox ID="txtPrice" type="text" class="form-control rounded-left" placeholder="Price" runat="server" required></asp:TextBox>
                            </div>


                            <div class="form-group">

                                <asp:Button ID="btnAddCategory" runat="server" class="btn btn-primary rounded submit p-3 px-5" Text="Add Item" OnClick="btnAddCategory_Click" />
                            </div>
                        </form>
                    </div>
                </div>

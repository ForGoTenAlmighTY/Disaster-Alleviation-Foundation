    ...
    <form id="form1" runat="server">
        ...
        <div class="auto-style9">
            ...
            <div class="recentlyadded content-wrapper">
                ...
                <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataGoods" Height="168px" Width="770px" CellSpacing="2" CssClass="auto-style6" DataKeyNames="Disaster Number">
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataGoods" runat="server" ConnectionString="<%$ ConnectionStrings:DisasterAlleviationDatabaseConnectionString %>" SelectCommand="SELECT Goods.NumItems, Goods.DonorName, Goods.DateDonation, Goods.Category, Goods.Quantity, Goods.Description, Disaster.DisID AS 'Disaster Number' FROM Goods INNER JOIN Disaster ON Goods.DisID = Disaster.DisID"></asp:SqlDataSource>
